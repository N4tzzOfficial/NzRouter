// REAL integration test: hits localhost:20514/v1 with real API key for all antigravity models.
...
//   RUN_REAL=1 AG_URL=http://localhost:20514/v1 AG_KEY=sk-xxx npx vitest run ...
//
import { describe, it, expect } from "vitest";

const RUN_REAL = process.env.RUN_REAL === "1";
const BASE_URL = process.env.AG_URL || "http://localhost:20514/v1";
