...
Common issues and solutions when using NzRouter.
...
1. **Auto-refresh (default):**
   NzRouter automatically refreshes tokens. Wait 30 seconds and retry.
...
1. **Check if NzRouter is running:**
   ```bash
   # Check process
