...
Combos are **custom fallback chains** that you create in the dashboard. Instead of using a single model, you define a sequence of models that N4tzzOfficial tries in order.
...
N4tzzOfficial automatically tries each model in sequence until one succeeds.
...
When limit reached, N4tzzOfficial skips paid models and uses free tier only.
