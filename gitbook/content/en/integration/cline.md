...
Integrate N4tzzOfficial with Cline VSCode extension to route your AI requests through N4tzzOfficial's intelligent routing system.
...
Set the base URL to your N4tzzOfficial endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your N4tzzOfficial endpoint
...
3. The key should start with `sk-N4tzzOfficial-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your N4tzzOfficial configuration
...
4. Cline will use N4tzzOfficial to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using N4tzzOfficial
...
3. Get AI-powered explanations through N4tzzOfficial

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use N4tzzOfficial to understand context and make changes
...
2. Verify your N4tzzOfficial instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check N4tzzOfficial logs for any errors
...
1. In Cline settings, set Base URL to: `https://n4tzzofficial.my.id/nzrouter`
2. Make sure you have configured your API key in the N4tzzOfficial cloud dashboard
...
## Integration with N4tzzOfficial Features

### Model Routing

N4tzzOfficial automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, N4tzzOfficial automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through N4tzzOfficial dashboard:
- Total requests
- Token usage
- Cost per model
