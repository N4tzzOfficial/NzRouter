...
将 N4tzzOfficial 部署到 VPS 或 Docker,实现远程访问和生产使用。
...
| `DATA_DIR` | `~/.N4tzzOfficial` | 数据库与数据存储路径 |
...
创建 `/etc/nginx/sites-available/N4tzzOfficial`:
