...
Triển khai N4tzzOfficial trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.N4tzzOfficial` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/N4tzzOfficial`:
...
# Network connections
netstat -tulpn | grep -E '3000|20514'
```
