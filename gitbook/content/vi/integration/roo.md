...
Tích hợp N4tzzOfficial với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model N4tzzOfficial có sẵn:
...
### Connection Failed
- Xác minh N4tzzOfficial đang chạy: `curl http://localhost:20128/health`
