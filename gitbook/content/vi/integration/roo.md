...
Tích hợp NzRouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model NzRouter có sẵn:
...
### Connection Failed
- Xác minh NzRouter đang chạy: `curl http://localhost:20128/health`
