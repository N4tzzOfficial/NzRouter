...
**NzRouterは、サブスクリプションの価値を最大化し、コストを最小限に抑えるAIモデルルーターです。**
...
**はい、NzRouter自体は100%無料でオープンソースです。**
...
**NzRouterはすべてのプロバイダーのクォータをリアルタイムで追跡します:**
...
## NzRouterをセルフホストできますか?

**はい! NzRouterは複数のデプロイメントオプションをサポートします:**
...
- **ドキュメント:** [n4tzzofficial.my.id/nzrouter/docs](https://n4tzzofficial.my.id/nzrouter/docs)
