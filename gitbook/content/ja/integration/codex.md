...
NzRouterをOpenAI Codex CLIと統合し、OpenAI APIリクエストをNzRouterのインテリジェントルーティングシステム経由でルーティングします。
...
1. NzRouterダッシュボードでAPIキーが正しいか確認
...
1. モデル名がNzRouter設定と一致するか確認
2. NzRouterダッシュボードでOpenAIプロバイダー接続がアクティブか確認
