...
リモートアクセスと本番利用のため、VPSまたはDockerにNzRouterをデプロイ。
...
| `DATA_DIR` | `~/.N4tzzOfficial` | データベースとデータの保存パス |
...
`/etc/nginx/sites-available/N4tzzOfficial` を作成:
...
# リバースプロキシを使用しない場合、NzRouterポートを許可
