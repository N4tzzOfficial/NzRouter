...
// Build TOML config for NzRouter (openai provider mode)
const buildNzRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect NzRouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildNzRouterConfig(baseUrl, apiKey || "sk_nzrouter", model);
