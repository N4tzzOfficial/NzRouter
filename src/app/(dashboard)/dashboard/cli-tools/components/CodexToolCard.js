...
export default function CodexToolCard({ tool, isExpanded, onToggle, baseUrl, apiKeys, activeProviders, cloudEnabled, initialStatus, tunnelEnabled, tunnelPublicUrl, tailscaleEnabled, tailscaleUrl }) {
  ...
  const handleApplySettings = async () => {
    ...
    setMessage(null);
    try {
      // Use sk_nzrouter for localhost if no key, otherwise use selected key
  ...
  const getManualConfigs = () => {
    ...
    const configContent = `# NzRouter Configuration for Codex CLI
model = "${selectedModel}"
model_provider = "nzrouter"

[model_providers.nzrouter]
name = "NzRouter"
base_url = "${getEffectiveBaseUrl()}"
wire_api = "responses"

[model_providers.nzrouter.http_headers]
