 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what nzrouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a nzrouter
 ...
 * The suffix is a nzrouter request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a nzrouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a nzrouter synthetic thinking variant
...
/**
 * Resolve a nzrouter model id to the real upstream Kiro model id, plus flags
