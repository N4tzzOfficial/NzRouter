 ...
 * API. They are nzrouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic nzrouter variant set for a single upstream Kiro model.
 *
 ...
 * into nzrouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
