...
const APP_NAME = "nzrouter";
const APP_LABEL = "com.nzrouter.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when nzrouter is currently
 ...
 * SIGTERM to the running process. When the running nzrouter cli.js was itself
...
<dict>
    ...
    <string>/tmp/nzrouter.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/nzrouter.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `nzrouter.cmd` lookup that depended on the npm prefix path.
