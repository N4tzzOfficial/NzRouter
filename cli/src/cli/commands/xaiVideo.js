/**
 * `nzrouter xai video` — generate a Grok Imagine video through the local
 * nzrouter gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: nzrouter xai video --prompt "..." [options]

Generate a Grok Imagine video via your local nzrouter gateway
...
Options:
  ...
  --api-key <key>         nzrouter API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-nzrouter-connection-id"] || null;
