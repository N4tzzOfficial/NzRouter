...
function resolveStandaloneBuild(appDir, buildDistDir) {
  ...
  // NEXT_TRACING_ROOT_MODE=workspace, e.g. standalone/nzrouter/server.js.
...
function buildCliPackage() {
  console.log("📦 Building NzRouter CLI package with Next.js...\n");
  ...
  // Strip better-sqlite3 (native) — it lives in ~/.nzrouter/runtime to avoid
  ...
  if (fs.existsSync(betterDir)) {
    ...
    console.log("✅ Stripped better-sqlite3 (lives in ~/.nzrouter/runtime)");
  }
  console.log("");
