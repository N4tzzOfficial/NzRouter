...
The same matrix applies to nzrouter's virtual `-review` variants because they
...
- Adding Codex Ultra's multi-agent orchestration behavior inside nzrouter;
  nzrouter only forwards the catalog-advertised reasoning override.
